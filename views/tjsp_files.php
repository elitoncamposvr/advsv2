<div class="breadcrumb">
    <span class="breadcrumb-title">TJSP <i class="fa-solid fa-chevron-right px-2"></i> <?php echo $tjsp_info['id']; ?> - <?php echo $tjsp_info['nome']; ?> <i class="fa-solid fa-chevron-right px-2"></i> ARQUIVOS</span>
    <span class="breadcrumb-btns">
        <span>
            <a href="<?php echo BASE_URL; ?>tjsp/edit/<?php echo $tjsp_info['id']; ?>" class="btn-alert hover:btn-alert--hover"><i class="fa-solid fa-angles-left"></i> Voltar</a>
        </span>
    </span>
</div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        <form action="<?php echo BASE_URL; ?>tjsp/files_send" method="post" enctype="multipart/form-data">
            <input type="hidden" name="client_id" value="<?php echo $tjsp_info['id']; ?>">
    ...
    <?php foreach ($images as $image) : ?>
        <div class="flex items-center w-full bg-slate-300 p-3 rounded-md">
            ...
            <div class="w-1/12 text-right">
                <a class="icon hover:icon--hover" href="<?php echo BASE_URL; ?>images/tjsp/<?php echo $image['image']; ?>" download><i class="fa-solid fa-download"></i></a>
            </div>
        </div>
    <?php endforeach; ?>
</div>
