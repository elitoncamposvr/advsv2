...
<?php if ($count_calc > 0) : ?>
    <form class="forms px-1" target="_blank" method="post" action="<?php echo BASE_URL; ?>tjsp/update/<?php echo $tjsp_info['id']; ?>">
    <?php else : ?>
        <form class="forms border rounded-md px-1 bg-slate-100" target="_blank" method="post" action="<?php echo BASE_URL; ?>proposta/store_without_pdf">
        <?php endif; ?>
